    ...
    $.fn.multiStepForm = function (options) {
        ...
        form.tryNavigateToView = function (currentIndex, targetIndex) {
            if (targetIndex <= currentIndex) {
                ...
                if (!settings.hideBackButton) form.setActiveView(targetIndex);
                return;
            }
        ...
        form.init = function () {
                ...
                this.initStep = function (index, view) {
                    ...
                    if (settings.allowClickNavigation) {
                        ...
                        $(form.steps[index]).click(function (e) {
                            ...
                            var targetIndex = form.steps.index(
                                $(e.target).closest("." + msfCssClasses.step)[0]
                            );
            ...
            this.initNavigation = function () {
                ...
                this.initNavButton = function (type) {
                    var element = this.navigation.find(
                            "button[data-type='" +
                                type +
                                "'], input[type='button']"
                        ),
            ...
            this.views.each(function (index, view) {
                ...
                $(view).on("hide", function (e) {
                    ...
                    if (
                        $.data(e.target, msfJqueryData.validated) &&
                        $.data(e.target, msfJqueryData.visited)
                    ) {
                        form.setStatusCssClass(
                            step,
        ...
        form.validateViews = function (currentIndex, length, invalid) {
            currentIndex =
                typeof currentIndex === "undefined" ? 0 : currentIndex;
            ...
            if ($(form).data("validator")) {
                ...
                var currentValidationIgnoreSettingsArray =
                    validationIgnore.split(",");
